...
function sanitizeGeneratedHtml(html, prompt, language = "ja") {
  ...
  const scrollOverride =
    "<style>html,body{margin:0;width:100%;min-height:100%;height:auto!important;max-height:none!important;overflow:auto!important;}body{overscroll-behavior:contain;-webkit-overflow-scrolling:touch;}body>*{height:auto!important;min-height:100vh!important;max-height:none!important;overflow:visible!important;}main,.app,.screen,.container,.wrapper,.page{height:auto!important;min-height:100vh!important;max-height:none!important;overflow:visible!important;}</style>";
  safe = safe
